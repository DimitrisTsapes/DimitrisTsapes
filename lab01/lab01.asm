...
main:   # Words ending with ':' are **labels**
        ...
        lw      $s0, 0($a0)     # system service 4: print string
        addu    $v0, $zero, $s0                       #   located at address $a0
        # This is a system call. We call the operating system
        #   to display a string for us. Think of it as a special
        #   subroutine.
        
        # system service 5: read integer
...
###############################################################################
        ...
        #  
matric: .word 2910    # This will be used by your submitted code
